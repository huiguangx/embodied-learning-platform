...
func Seed(db *sql.DB) error {
	...
	statements := []string{
		...
		`INSERT INTO queues (id,project_id,resource_group_id,name,priority,weight,concurrency,max_duration_seconds,scheduling_policy) VALUES ('00000000-0000-0000-0000-000000000301','00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000201','default',50,1,8,86400,'fifo'),('00000000-0000-0000-0000-000000000302','00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000201','priority',100,2,4,172800,'priority'),('00000000-0000-0000-0000-000000000303','00000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000202','idc-default',50,1,4,86400,'fifo') ON CONFLICT (id) DO NOTHING`,
